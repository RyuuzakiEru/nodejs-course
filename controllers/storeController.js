...
exports.getStores = async (req, res) => {
    ...
    res.render('stores', {title: 'Store List', stores: stores, page, pages, count});
}
...
const confirmOwner = (store, user) => {
    if (!store.author.equals(user._id)){
        throw Error('You\'re not the owner');
    }
}
...
exports.updateStore = async (req, res) => {
    // set location type to Point, since defaults don't apply in update
